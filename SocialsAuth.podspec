...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "thachnn" => "" }
  # Or just: spec.author    = "thachnn"
  # spec.authors            = { "thachnn" => "" }
  # spec.social_media_url   = "https://twitter.com/thachnn"
  ...
  spec.source       = { :path => '.' }
  spec.source       = { :git => "https://github.com/NguyenNgocThach131193/SocialsAuth.git", :tag => "1.0.3" }
